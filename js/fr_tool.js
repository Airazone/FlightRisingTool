...
FRTool.AurboaSecondaryGene = function(name, odds, price) {
    this.Name = name;
    this.Odds = FRTool.Odds[odds];
    this.Price = price;
...
FRTool.initFR = function(data) {
    ...
    for (var i = 0; i < data.AurboaPrimaryGeneList.length; i++) {
